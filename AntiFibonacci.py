...
---------------------------------------- Link for the challenge: https://codeforces.com/problemset/problem/1644/B -------------------------------------
...
Output
For each test case, print n lines. Each line should contain an anti-Fibonacci permutation of length n. 
...
for _ in range(cases):
    ...
    for i in range(1, n):
        # Swap elements at positions n - i and n - i - 1
        base[n - i], base[n - i - 1] = base[n - i - 1], base[n - i]
        results.append(base[:])
