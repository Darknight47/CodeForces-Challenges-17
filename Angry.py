"""
----------------------------------------- Link for the challenge: https://codeforces.com/problemset/problem/1992/B --------------------------------------
...
Pick a slice a(i) and another slice with length aj=1 (i≠j) and merge them into one piece with length ai+1. As a result, the number of pieces will decrease by 1.
...
The second line contains k integers a1,a2,…,ak (1 ≤ a(i) ≤ n−1, ∑ai=n) — lengths of pieces of casserole, which Noobish_Monk has cut.
