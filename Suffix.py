"""
----------------------------------- Link for the challenge: https://codeforces.com/problemset/problem/1281/A ------------------------------------
...
for _ in range(cases):
    s = input()
    temp1 = s[-5:] if len(s) >= 5 else None
    temp2 = s[-4:] if len(s) >= 4 else None
    temp3 = s[-2:] if len(s) >= 2 else None

    if(temp1 and temp1 == 'mnida'):
        print('KOREAN')
    elif(temp2 and temp2 == 'desu' or temp2 == 'masu'):
        print('JAPANESE')
    elif(temp3 and temp3 == 'po'):
        print('FILIPINO')